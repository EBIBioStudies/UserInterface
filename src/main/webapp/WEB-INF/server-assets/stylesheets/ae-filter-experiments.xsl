...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <func:function name="ae:filter-experiments">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$pInAtlas!='true' and $pArray!='' and $pSpecies!='' and $pKeywords!='' and $pExperimentType=''">
            ...
            <xsl:when test="$pInAtlas='true' and $pArray!='' and $pSpecies!='' and $pKeywords!='' and $pExperimentType=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testSpecies(.,$pSpecies)][helper:testArray(.,$pArray)][helper:testKeywords(.,$pKeywords,$pWholeWords)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray!='' and $pSpecies='' and $pKeywords='' and $pExperimentType=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testArray(.,$pArray)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray='' and $pSpecies!='' and $pKeywords='' and $pExperimentType=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testSpecies(.,$pSpecies)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray='' and $pSpecies='' and $pKeywords!='' and $pExperimentType=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testKeywords(.,$pKeywords,$pWholeWords)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray!='' and $pSpecies!='' and $pKeywords='' and $pExperimentType=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testSpecies(.,$pSpecies)][helper:testArray(.,$pArray)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray='' and $pSpecies!='' and $pKeywords!='' and $pExperimentType=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testSpecies(.,$pSpecies)][helper:testKeywords(.,$pKeywords,$pWholeWords)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray!='' and $pSpecies='' and $pKeywords!='' and $pExperimentType=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testArray(.,$pArray)][helper:testKeywords(.,$pKeywords,$pWholeWords)]"/>
            </xsl:when>

            <xsl:when test="$pInAtlas='true' and $pArray!='' and $pSpecies!='' and $pKeywords!='' and $pExperimentType!=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testExperimentType(.,$pExperimentType)][helper:testSpecies(.,$pSpecies)][helper:testArray(.,$pArray)][helper:testKeywords(.,$pKeywords,$pWholeWords)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray!='' and $pSpecies='' and $pKeywords='' and $pExperimentType!=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testExperimentType(.,$pExperimentType)][helper:testArray(.,$pArray)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray='' and $pSpecies!='' and $pKeywords='' and $pExperimentType!=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testExperimentType(.,$pExperimentType)][helper:testSpecies(.,$pSpecies)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray='' and $pSpecies='' and $pKeywords!='' and $pExperimentType!=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testExperimentType(.,$pExperimentType)][helper:testKeywords(.,$pKeywords,$pWholeWords)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray!='' and $pSpecies!='' and $pKeywords='' and $pExperimentType!=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testExperimentType(.,$pExperimentType)][helper:testSpecies(.,$pSpecies)][helper:testArray(.,$pArray)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray='' and $pSpecies!='' and $pKeywords!='' and $pExperimentType!=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testExperimentType(.,$pExperimentType)][helper:testSpecies(.,$pSpecies)][helper:testKeywords(.,$pKeywords,$pWholeWords)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray!='' and $pSpecies='' and $pKeywords!='' and $pExperimentType!=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testExperimentType(.,$pExperimentType)][helper:testArray(.,$pArray)][helper:testKeywords(.,$pKeywords,$pWholeWords)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray='' and $pSpecies='' and $pKeywords='' and $pExperimentType!=''">
                <func:result select="experiment[@loadedinatlas='true'][helper:testExperimentType(.,$pExperimentType)]"/>
            </xsl:when>
            <xsl:when test="$pInAtlas='true' and $pArray='' and $pSpecies='' and $pKeywords='' and $pExperimentType=''">
                <func:result select="experiment[@loadedinatlas='true']"/>
            </xsl:when>
            <xsl:otherwise>
