...
import uk.ac.ebi.arrayexpress.AEInterfaceTestApplication;
...
{
    private final String EXPERIMENT_TEST_XML = "<?xml version=\"1.0\"?>" +
        "<experiment id=\"1711258082\" accession=\"E-GEOD-9914\" name=\"Transcription profiling of mouse knock in mutant model for spinocerebellar ataxia type 1 and type 7 - symptomatic Sca1154Q/2Q and Sca7266Q/5Q cerebellum\" releasedate=\"2009-01-08\">" +
        "<user>1</user>" +
    ...
    public void testParse()
    {
        ...
        SearchEngine search = (SearchEngine)Application.getAppComponent("SearchEngine");
        search.addToIndex(experiment);
        search.queryIndex("name:Transcription");
    }
}
