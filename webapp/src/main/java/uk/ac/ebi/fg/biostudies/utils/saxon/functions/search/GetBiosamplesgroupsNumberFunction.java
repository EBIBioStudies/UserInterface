...
import uk.ac.ebi.fg.biostudies.utils.saxon.search.IndexEnvironmentBiosamplesGroup;

public class GetBiosamplesgroupsNumberFunction extends ExtensionFunctionDefinition
{
    private static final long serialVersionUID = 7070707985404434594L;

    private static final StructuredQName qName =
            new StructuredQName("", NamespaceConstant.AE_SEARCH_EXT, "getBiosamplesgroupsNumber");

    private Controller searchController;

    public GetBiosamplesgroupsNumberFunction( Controller controller )
    {
    ...
    private static class GetBiosamplesgroupsNumberCall extends ExtensionFunctionCall
    {
        ...
        {
        	IndexEnvironmentBiosamplesGroup indexExp = (IndexEnvironmentBiosamplesGroup)searchController.getEnvironment("biosamplesgroup");
