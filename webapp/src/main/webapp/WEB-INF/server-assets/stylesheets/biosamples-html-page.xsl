...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--
            ...
            <link rel="stylesheet" href="{$basepath}/assets/stylesheets/biosamples_common_10.css" type="text/css"/>
           <!--  <link rel="stylesheet" href="{$basepath}/assets/stylesheets/biosamples_html_page_10.css" type="text/css"/>  -->
                ...
                <div id="ae_noscript" class="bs_contents_frame bs_assign_font bs_white_bg">
                    <div class="bs_center_box">
                        <div id="bs_contents_box_915px">
                            <div class="ae_error_area">BioSamples uses JavaScript for better data handling and enhanced representation. Please enable JavaScript if you want to continue browsing BioSamples.</div>
                        </div>
                    </div>
                </div>
            </noscript>
    ...
    <xsl:template name="page-body-plain">
        <body>
            <div id="bs_contents" class="bs_assign_font"><xsl:call-template name="ae-contents"/></div>
        </body>
    </xsl:template>
