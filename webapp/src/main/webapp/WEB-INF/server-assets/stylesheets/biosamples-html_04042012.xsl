...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
		...
		<div id="ae_contents_box_100pc">
			<div id="ae_content">
				<div id="ae_navi">
					...
					<xsl:text> > </xsl:text>
					<a href="{$basepath}/biosamples">Bio Samples</a>
					<xsl:if test="not($vBrowseMode)">
						<xsl:text> > </xsl:text>
						<a href="{$basepath}/biosamples/{$id}">
	...
	<xsl:template name="detail-table">
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td>
					<xsl:value-of select="attribute/value[../@class='Name']"></xsl:value-of>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<xsl:value-of select="attribute/value[../@class='Submission Title']"></xsl:value-of>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<xsl:value-of select="attribute/value[../@class='Submission Identifier']"></xsl:value-of>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td colspan="2">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<!-- <xsl:call-template name="detail-samples"> <xsl:with-param name="pSamples" 
							select="/Sample"/> </xsl:call-template> -->
	...
	<xsl:template match="Sample">
		...
		<tr>
			<td>
				<xsl:value-of select="attribute/value[../@class='Name']" />
			</td>
			<td>
				<xsl:value-of select="attribute/value[../@class='Sample Accession']" />
			</td>
			<td>
				<xsl:value-of select="attribute/value[../@class='DiseaseType']" />
			</td>
			<td>
				<xsl:value-of select="attribute/value[../@class='SampleType']" />
			</td>
			<td>
				<xsl:value-of select="@id" />
			</td>
